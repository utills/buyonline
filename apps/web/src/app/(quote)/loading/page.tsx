  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 space-y-8">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 w-24 h-24 rounded-full border-4 border-transparent border-t-[#ED1B2D] animate-spin" />
        <div className="absolute inset-0 flex items-center justify-center">
          <svg className="w-10 h-10 text-[#ED1B2D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {['Analyzing your profile', 'Comparing plans', 'Calculating premiums'].map(
          (step, i) => (
            <div key={i} className="flex items-center gap-3 animate-pulse" style={{ animationDelay: `${i * 0.5}s` }}>
              <div className="w-5 h-5 rounded-full bg-[#ED1B2D] flex items-center justify-center flex-shrink-0">
