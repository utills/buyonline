...
const DECLARATION_SECTIONS = [
  {
    ...
    icon: (
      <svg className="w-5 h-5 text-[#ED1B2D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="w-full py-4 bg-[#ED1B2D] text-white font-semibold rounded-xl hover:bg-[#c41530] active:bg-[#a81229] transition-colors"
      >
        Submit Declaration
      </button>
    </div>
